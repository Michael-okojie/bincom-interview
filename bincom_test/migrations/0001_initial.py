# Generated by Django 4.1.3 on 2022-11-06 05:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_entered', models.DateTimeField()),
                ('user_ip_address', models.CharField(max_length=50)),
                ('lga_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bincom_test.lga')),
            ],
            options={
                'db_table': 'ward',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lga_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bincom_test.lga')),
                ('ward_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bincom_test.ward')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='lga',
            name='state_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bincom_test.states'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_entered', models.DateTimeField()),
                ('user_ip_address', models.CharField(max_length=50)),
                ('ward_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bincom_test.ward')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_entered', models.DateTimeField()),
                ('user_ip_address', models.CharField(max_length=50)),
                ('state_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bincom_test.states')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_entered', models.DateTimeField()),
                ('user_ip_address', models.CharField(max_length=50)),
                ('lga_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bincom_test.lga')),
            ],
            options={
